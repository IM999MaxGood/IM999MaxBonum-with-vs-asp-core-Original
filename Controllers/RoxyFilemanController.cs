...
namespace IM999MaxBonum.Controllers
{
    ...
    //999/
    //public class RoxyFilemanController : BaseController
    //public class RoxyFilemanController(IHostingEnvironment environment) : BaseController(environment)
    public class RoxyFilemanController : BaseController
    {
        ...
        //public override RoxyFilemanController(IHostingEnvironment env)
        public RoxyFilemanController(IHostingEnvironment env) : base(env)
        {
            /*
            ...
            if(clsGeneralFunction.InsideIIS()){
                if(Directory.Exists(AppDomain.CurrentDomain.BaseDirectory+"\\wwwroot\\lib\\fileman"))
                    _systemRootPath = AppDomain.CurrentDomain.BaseDirectory;
            }
            */
            _systemRootPath = GetMainPath();

            //im999
            if (_systemRootPath.EndsWith("\\")) {
                _systemRootPath = _systemRootPath.Remove(_systemRootPath.Length-1);
            }
            ...
            _tempPath = _systemRootPath + "\\wwwroot\\UserFiles\\temp";
            _filesRootPath = "/wwwroot/UserFiles/";
            _filesRootVirtual = "/UserFiles/";
        ...
        public IActionResult DIRLIST(string type)
        {
            try
            {
                ...
                for (int i = 0; i < dirs.Count; i++)
                {
                    ...
                    //im999 not work in iss remove MakeVirtualPath
                    ...
                    //result += (result != "" ? "," : "") + "{\"p\":\"" + dir.Replace(localPath, "").Replace("\\", "/") + "\",\"f\":\"" + GetFiles(dir, type).Count.ToString() + "\",\"d\":\"" + Directory.GetDirectories(dir).Length.ToString() + "\"}";
                }
        ...
        */
        ...
        private string GetFilesRoot()
        {
            ...
            //999/
            if(SD.GetValue("RoxyFilemanRoot")!= null)
                ret = SD.GetValue("RoxyFilemanRoot");
